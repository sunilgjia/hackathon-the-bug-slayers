...
class UserListAdapter(private val listener: ClickListener) :
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(userModel: UserModel?) {
            ...
            binding.tvPayment.setOnCheckedChangeListener { buttonView, isChecked ->
                listener.onItemClickListener(userModel, view = buttonView)
            }
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.row_users_list, parent, false)
